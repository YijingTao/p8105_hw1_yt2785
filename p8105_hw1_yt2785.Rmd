...
**There are `r n_row` rows and `r n_col` columns in the dataset. Including `r penguins_colnames` in total 8 variables. The mean of flipper length is `r mean_flipper`.**
